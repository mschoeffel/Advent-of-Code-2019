...
func TestDay09Part1(t *testing.T) {
	...
	if actual != expected {
		t.Errorf("Test Day 09 Part 1 Test 1")
	}
	...
	if actual != expected {
		t.Errorf("Test Day 09 Part 1 Test 2")
	}
	...
	actual = Day9Part1(data, "0", true)
	if actual != expected {
		t.Errorf("Test Day 09 Part 1 Test 3")
	}
	...
	actual = Day9Part1(data, "0", true)
	if actual != expected {
		t.Errorf("Test Day 09 Part 1 Test 4")
	}
}
...
func TestDay09Part2(t *testing.T) {
	...
	if actual != expected {
		t.Errorf("Test Day 09 Part 2 Test 1")
	}
}
