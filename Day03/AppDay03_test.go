...
func TestDay03Part1(t *testing.T) {
	...
	if actual != expected {
		t.Errorf("Test Day 03 Part 1 Test 1")
	}
	...
	actual = Day3Part1(data)
	if actual != expected {
		t.Errorf("Test Day 03 Part 1 Test 2")
	}
	...
	actual = Day3Part1(data)
	if actual != expected {
		t.Errorf("Test Day 03 Part 1 Test 3")
	}
	...
	actual = Day3Part1(data)
	if actual != expected {
		t.Errorf("Test Day 03 Part 1 Test 4")
	}
}
...
func TestDay03Part2(t *testing.T) {
	...
	if actual != expected {
		t.Errorf("Test Day 03 Part 2 Test 1")
	}
	...
	actual = Day3Part2(data)
	if actual != expected {
		t.Errorf("Test Day 03 Part 2 Test 2")
	}
	...
	actual = Day3Part2(data)
	if actual != expected {
		t.Errorf("Test Day 03 Part 2 Test 3")
	}
	...
	actual = Day3Part2(data)
	if actual != expected {
		t.Errorf("Test Day 03 Part 2 Test 4")
	}
}
